...
public class TagsAdapterTest {
    ...
    public void testGetItemViewType() {
        ...
        assertNotNull(tagsAdapter.getItemViewType(0));
    }
    @Test
    ...
    public ArrayList<JSONObject> seleccionarTags(){
