            ...
            public void onItemClick(View v, final int position) {
                if (v != null) {
                    ...
                    if (position != -1) {
                        ...
                        //Todo hay  que tener en cuenta que cuando se hace de manera local esto funciona de una ,para la sincronizacion esto puede pisar los datos cuando sea en simultaneo
