        ...
        if (!mAuth.getCurrentUser().getUid().isEmpty()) {
            ...
            mDatabase.child(Constants.Grupos).child(mAuth.getCurrentUser().getUid()).child("URL_grupos_" + sharedPrefsDefault.getString(mContext.getString(R.string.str_idioma), locale)).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull final DataSnapshot dataSnapshotGrupos) {
                    ...
                    mStorageRefGrupos = FirebaseStorage.getInstance().getReference().child("Archivos_Usuarios").child("Grupos").child("grupos_" + mAuth.getCurrentUser().getEmail() + "_" + sharedPrefsDefault.getString(mContext.getString(R.string.str_idioma), "en") + "." + "txt");
                    mStorageRefPictos = FirebaseStorage.getInstance().getReference().child("Archivos_Usuarios").child("Pictos").child("pictos_" + mAuth.getCurrentUser().getEmail() + "_" + sharedPrefsDefault.getString(mContext.getString(R.string.str_idioma), "en") + "." + "txt");
                    mStorageRefFrases = FirebaseStorage.getInstance().getReference().child("Archivos_Usuarios").child("Frases").child("frases_" + mAuth.getCurrentUser().getEmail() + "_" + sharedPrefsDefault.getString(mContext.getString(R.string.str_idioma), "en") + "." + "txt");
